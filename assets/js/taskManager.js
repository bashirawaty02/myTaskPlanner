...
// let donebtn = document.getElementById("done-button");
  ...
  if (status === "IN PROGRESS") {
    statustag = `<span class="badge badge-success" style="background-color:red; font-size: 17px; padding: 8px">  ${status}</span>`;

  } else {
    statustag = `<span class="badge text-dark " style="background-color:green; font-size: 17px; padding: 9px"> ${status}</span>`;
  }
